-- 🔥 DT SYNC - Auto Item Stealer with Webhook & GUI
-- 👤 By DT-Deville
...
local ITEM_NAME = "Fruit" -- Pwede mo palitan: "Coin", "Pet", etc.
            ...
            for _, obj in pairs(workspace:GetDescendants()) do
                if obj:IsA("Part") and obj.Name == ITEM_NAME then
                    ...
                    if hrp then
                        ...
                        sendWebhook("📦 " .. game.Players.LocalPlayer.Name .. " collected: **" .. ITEM_NAME .. "** at " .. os.date("%X"))
                        wait(1)
                    end
                end
            end
